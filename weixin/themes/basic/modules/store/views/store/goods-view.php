...
<div class="d-prifno">
	<div class="fn-wrap">
		<div class="wrap-title">
			...
			<div class="wrap-xsprice">包邮价：<span class="fn-wrapprice">￥<span id="priceMain"><?=$detail['price_range']['min'] == $detail['price_range']['max'] ? $detail['price_range']['max'] : $detail['price_range']['min']."--".$detail['price_range']['max']?></span></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="jfblock" >返利<span id="zsjf"><?=OrderService::getGolds($detail['market_price'] - $detail['goods']->freight, $detail['goods']->egd)?></span></span></div>
			<!--<div class="wrap-sale"><span class="fn-wrapfont">优惠</span>：<span class="wrap-miquan">可用米券</span></div>-->
		</div>
		<a  href="#" class="make-wrap" style="display: none;">
			<div class="make-wraptext">转发赚钱</div>
		</a>
...
<div class="details-mode">
	<div class="d-linklist noborder">
		<a class="item" onclick="" href="<?=Url::to(['goods-description?id='.$detail['goods']->goods_id])?>">
			图文详情
			<i class="arrowent"></i>
		</a>
	</div>
	<div class="d-linklist noborder">
		<a class="item" onclick="" href="<?=Url::to(['goods-attr?id='.$detail['goods']->goods_id])?>">
			商品参数
			<i class="arrowent"></i>
		</a>
	</div>
...
<div class="details-mode pb-70">
	<div class="d-linklist">
		<a class="item" onclick="" href="<?= isset($detail['goods']->store) ? ('/store/store/store-view?id='.$detail['goods']->store->id):'' ?>">
