...
$this->title = Yii::t('app_member', 'my_cash_money');
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="balance-top mt10 bt clearfix">
	<div class="fl fon16"><?=yii::t('app_member','my_cash_money')?></div>
	<div class="price fr">￥<?=$money['cash_money']?></div>
</div>
<!--balance-top 顶部信息 E-->
...
<div class="xzzf-title balance-buttom-title">
	<div class="inxzzf-title inbalance-title">
		<div class="xzzf-title-box">
			<div class="inxzzf-title-box f18">米券明细</div>
		</div>
	</div>
</div>
<!-- xzzf-title 我的余额标题 E-->
