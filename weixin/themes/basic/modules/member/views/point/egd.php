...
<div class="balance-top my-jftx-top">
	...
	<div class="f12 clearfix"><div class="fl">可提取EGD : <span class="r-fc"><?=$moneyModel->gold_points?></span></div><div class="fr">当前网络黄金价格：<span class="r-fc"><?=$edgMoney['hj_integral']?>元/块</span></div></div>
</div>
<!--顶部信息 E-->
