...
$this->title = Yii::t('app_member', 'update_zf_pwd');
...
<div class="input-box-wrap input-box-getwrap">
			...
			<button class="dm-get-btn" id='verify_btn' 
				data-url='<?=Url::toRoute(['verify','mobile'=>$model['mobile'],'type'=>CommonService::VERIFY_TYPE_PAYPWD])?>'>
				<?=yii::t('app_member','get_validate_code')?>
			</button>
</div>
	
	<div class="input-box-wrap">
		<?= $form->field($model, 'zf_pwd',['options'=>['class'=>'form-group span8']])->passwordInput(['maxlength' => true]) ?>
	</div>
