...
<!-- product productinfo-->
<div class="d-prifno">
	<div class="fn-wrap bb">
		<div class="wrap-title">
			<h2><?=$detail['goods']->name?></h2>
		    <div class="wrap-xsprice">订金：<span class="fn-wrapprice">￥<span id="priceMain"><?=$detail['price_range']['min'] == $detail['price_range']['max'] ? $detail['price_range']['max'] : $detail['price_range']['min']."--".$detail['price_range']['max']?></span></span><span class="jfblock" ></div>

			<div class="wrap-yxprice">经销指导价：<span id="zdPriceMain"><?=$detail['price_range']['minMarket'] == $detail['price_range']['maxMarket'] ? $detail['price_range']['maxMarket'] : $detail['price_range']['minMarket']."--".$detail['price_range']['maxMarket']?></span></div>
		</div>
	...
	<div class="d-linklist"  id="open-sb" style="display: none;">
...
<div class="details-mode">
	...
	<div class="qc-discount">
		<div class="qcxq-jf">
			<div><span class="qcxq-jf-icon"><i></i>积分</span>购买即可得订金价值<span class="r-fc2"><?=$detail['goods']['egd'] * 100?>%</span>的积分</div>
