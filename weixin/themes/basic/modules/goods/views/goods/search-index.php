   ...
   <!-- <div class="d-tab-background">
    ...
    <div class="d-tab-background stick-tittle">
        <ul class="d-product-main">
        	<li>
                <a href="<?=Url::to(['search-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-shelves_time') ? 'shelves_time' : '-shelves_time').'&category_id_list='.$category_id_list.'&goods_name='.$goods_name.'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_shelves_time ?>">
                                        综合
            ...
            <li>
                <a href="<?=Url::to(['search-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-sales') ? 'sales' : '-sales').'&category_id_list='.$category_id_list.'&goods_name='.$goods_name.'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_sales ?>">
                    <i>销量</i>
            ...
            <li>
                <a href="<?=Url::to(['search-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-market_price') ? 'market_price' : '-market_price').'&category_id_list='.$category_id_list.'&goods_name='.$goods_name.'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_price ?>">
                    价格
