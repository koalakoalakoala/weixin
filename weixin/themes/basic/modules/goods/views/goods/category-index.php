...
<div class="d-commodity-list">
    ...
    <li>
                <a href="<?=Url::to(['category-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-shelves_time') ? 'shelves_time' : '-shelves_time').'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_shelves_time ?>">
                    综合
            ...
            <li>
                <a href="<?=Url::to(['category-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-sales') ? 'sales' : '-sales').'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_sales ?>">
                    <i>销量</i>
            ...
            <li>
                <a href="<?=Url::to(['category-index?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-market_price') ? 'market_price' : '-market_price').'&price='.$price.'&brand_id='.$brand_id.'&category_id='.$category_id])?>" class="sort-btn <?= $font_color_price ?>">
                    价格
                ...
                <div class="d-sidebar-container d-sidebar-container_p">
                    <div class="d-sidebar-main">
                        <?php $form = ActiveForm::begin([
                            'method' => 'post',
                            'id'=>'searchForm',
                            'action'=>Url::toRoute('/goods/goods/category-index')
                        ]); ?>
                        <ul>
