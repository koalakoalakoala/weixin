...
<div class="d-tab-background">
    <ul class="d-product-main">
        <li>
            <a href="<?=Url::to(['exsearch?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-zh') ?
                    'zh' : '-zh')])?>"
        ...
        <li>
            <a href="<?=Url::to(['exsearch?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-sales') ?
                    'sales' : '-sales')])?>"
        ...
        <li>
            <a href="<?=Url::to(['exsearch?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-market_price') ?
            ...
            <ul>
                <?php
                    echo ListView::widget([
                        ...
                        'itemView' => '_item-search-exchange',
                        'layout' => '{items}{pager}',
                        'emptyText' => '暂无活动数据',
                        'pager' => [
