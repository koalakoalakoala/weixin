...
<div class="d-tab-background stick-tittle">
    <ul class="d-product-main">
        <li>
            <a href="<?=Url::to(['m-coupon?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-zh') ?
                    'zh' : '-zh')])?>"
        ...
        <li>
            <a href="<?=Url::to(['m-coupon?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-sales') ?
                    'sales' : '-sales')])?>"
        ...
        <li>
            <a href="<?=Url::to(['m-coupon?sort='.((isset($_GET['sort']) && $_GET['sort'] == '-market_price') ?
